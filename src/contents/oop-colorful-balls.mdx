...
有一段时间没有更新了, 前几天学习ES6的时候跟着教程做了个绚丽小球, 这里是[项目地址](https://github.com/docodocool/colorful-balls), [演示地址](#/practice/colorfulballs).  
这个项目蛮简单的, 主要思路就是创建一个小球类`class Ball{}`以及子类`class MoveBall{}`, 通过监听鼠标移动在canvas上绘制随机颜色的小球, 并向随机方向移动.  
#### 一.创建小球类
